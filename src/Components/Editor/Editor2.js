...
function Editor2() {
  ...
  let maxp = 10*Math.exp(-0.23 * (new Date('Sun Jan 24 2021 11:25:00 GMT+0530') - new Date('Sun Jan 24 2021 01:00:20 GMT+0530'))/(1000*60*60))
  console.log(maxp)
  ...
  const submit = async () => {
    ...
    {
      let timeTaken = (new Date('Sun Jan 24 2021 11:49:20 GMT+0530') - new Date('Sun Jan 24 2021 11:25:20 GMT+0530')) / (60 * 10 *10);
  ...
  return (
    <div>
      <div>
        ...
        <p>Sun Jan 24 2021 11:25:20 GMT+0530</p>
      </div>
      <AceEditor
        ref={codeRef}
        mode='python'
