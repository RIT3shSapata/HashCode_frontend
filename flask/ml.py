...
for connection in connections:
    ...
    adj_list[int(source)-1].append((int(destination)-1,
                                    final_mat[int(source)-1][int(destination)-1][1]))
# print(adj_list)
...
def get_recommend():
    ...
    exp1, exp2, exp3, x = get_exp()[1], get_exp()[
        2], get_exp()[3], get_exp()[0]
